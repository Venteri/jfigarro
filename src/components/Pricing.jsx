    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos accusamus assumenda dolores accusantium ullam eligendi deserunt repellat! Molestias, illum id!</p>
            </div>
            <div className='grid md:grid-cols-2'>
                ...
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-2xl text-sm'>Standard</span>
                    <div>
                        <p className='text-6xl font-bold py-4 flex'>€999<span className='text-xl text-slate-500 flex flex-col justify-end'>/day</span></p>
                    </div>
                    <p className='text-2xl py-8 text-slate-500'>Lorem ipsum dolor sit amet consectetur adipisicing.</p>
                    <div className='text-2xl'>
                        <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'/>Lorem, ipsum dolor.</p>
